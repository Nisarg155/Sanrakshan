...
exports.analyzeContractWithAI = exports.detectPrivacyType = exports.extractTextToPdf = void 0;
...
//     }
// }
const extractTextToPdf = (filekey) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const pdf = yield pdfjs.getDocument({ data: fileBuffer }).promise;
        let text = "";
        for (let i = 0; i < pdf.numPages; i++) {
...
exports.extractTextToPdf = extractTextToPdf;
const detectPrivacyType = (privacyText) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
    const result = yield aiModel.generateContent(prompt);
    const response = result.response;
    return response.text().trim();
});
exports.detectPrivacyType = detectPrivacyType;
